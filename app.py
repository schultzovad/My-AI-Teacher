...
# --- 2. CSS OPRAVA (ODSTRÁNENIE OKRAJOV A BIELYCH MIEST) ---
st.markdown("""
    <style>
    /* Odstráni prázdny priestor úplne hore */
    .stApp {
        margin-top: -70px;
    }
    ...
    /* Maximalizuje využitie priestoru v Embed boxe */
    .block-container {
        padding-top: 0rem;
        padding-bottom: 0rem;
    }
...
with st.sidebar:
    ...
    # TLAČIDLO DOMOV (Tu si môžeš kedykoľvek zmeniť adresu)
    ...
    st.divider()
    # Navigácia vnútri aplikácie
    page_selection = st.radio("Sekcia", [t["c"], t["f"], t["g"]])

# --- 5. LOGIKA SKRÝVANIA (Dôležité pre Framer) ---
# Ak adresa neobsahuje parameter ?p=, aplikácia sa nevykreslí (nezaberie miesto na domovskej stránke)
