...
lang_data = {
    ...
    "UA": {"nav_title": "Навігація", "home": "🏠 Головна", "chat_title": "🤖 AI Тьютор", "forum_title": "📚 Навчальні материалы", "groups_title": "👥 Навчальні групи", "input_placeholder": "Чим я можу вам допомогти?", "upload_label": "Завантажте свої нотатки", "success_upload": "Файл успішно завантажено!", "create_group": "Створити нову групу"},
...
with st.sidebar:
    ...
    # Tlačidlo DOMOV (Návrat na hlavný web)
...
# Ak nie je v URL ?p=, automaticky nastavíme "chat"
...
if selected_page == "chat":
    ...
    if prompt := st.chat_input(t["input_placeholder"]):
        ...
        with st.chat_message("assistant"):
            response = f"Simulovaná odpoveď ({lang}): Rozumiem, analyzujem vaše zadanie."
    ...
    nazov_skupiny = st.text_input("Name of group")
    if st.button(t["create_group"]):
        st.balloons()
        st.success(f"Skupina '{nazov_skupiny}' vytvorená!")

else:
    st.error("Sekcia neexistuje. Vráťte sa cez menu.")
