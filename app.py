...
lang_data = {
    ...
    "IT": {"h": "🏠 Home", "c": "🤖 Tutor IA", "f": "📚 Materiali di studio", "g": "👥 Gruppi di studio", "i": "Come posso aiutarti?", "u": "Carica le tue note", "s": "File caricato con successo!", "n": "Crea nuovo grupo"},
...
with st.sidebar:
    ...
    # Tlačidlo DOMOV - vráti ťa na základnú URL bez parametrov
...
# --- 4. LOGIKA SKRÝVANIA (DÔLEŽITÉ PRE FRAMER) ---
query_params = st.query_params
selected_page = query_params.get("p", None)

# Ak nie je vybraná žiadna sekcia, Streamlit zastaví vykresľovanie (žiadna biela plocha)
if selected_page is None:
    st.stop()

# Zobrazenie obsahu podľa výberu
if selected_page == "chat":
    ...
    if prompt := st.chat_input(t["i"]):
        ...
        response = f"Simulovaná odpoveď ({lang}): Analyzujem vaše zadanie."
    ...
    if uploaded_file: st.success(t["s"])
