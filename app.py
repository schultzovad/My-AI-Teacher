...
with st.sidebar:
    ...
    # Tlačidlo DOMOV - vráti ťa na čistú hlavnú stránku
...
# --- 4. LOGIKA SKRÝVANIA OBSAHU ---
query_params = st.query_params
selected_page = query_params.get("p", None)

# Ak v URL nie je parameter (teda človek práve prišiel na web), Streamlit nič nevykreslí
if selected_page is None:
    st.stop()

# Ak je vybraná konkrétna sekcia, zobrazí sa obsah
if selected_page == "chat":
    ...
    if prompt := st.chat_input(t["i"]):
        ...
        response = f"Simulovaná odpoveď ({lang}): Analyzujem text..."
