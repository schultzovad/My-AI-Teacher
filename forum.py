...
lang_data = {
    ...
    "DE": {"title": "📚 Lernmaterialien", "up": "Notizen hochladen", "ok": "Datei hochgeladen!", "bio": "Biologie", "dej": "Geschichte", "fyz": "Physik", "che": "Chemie", "mat": "Mathematik", "obn": "Sozialkunde", "geo": "Erdkunde", "inf": "Informatik", "sjl": "Slowakisch", "anj": "Englisch", "nej": "Deutsch", "frj": "Französisch", "esp": "Spanisch", "itj": "Italienisch", "ruj": "Russisch", "ukj": "Ukrainisch"},
    ...
    "UA": {"title": "📚 Навчальні матеріали", "up": "Завантажити", "ok": "Завантажено!", "bio": "Біологія", "che": "Хімія", "dej": "Історія", "fyz": "Фізика", "mat": "Математика", "obn": "Громадянська освіта", "geo": "Географія", "inf": "Інформатика", "sjl": "Словацька мова", "anj": "Англійська мова", "nej": "Німецька мова", "frj": "Французька мова", "esp": "Іспанська мова", "itj": "Італійська мова", "ruj": "Російська мова", "ukj": "Українська мова"},
    "RU": {"title": "📚 Учебные материалы", "up": "Загрузить", "ok": "Загружено!", "bio": "Биология", "dej": "История", "fyz": "Физика", "che": "Химия", "mat": "Математика", "obn": "Обществознание", "geo": "География", "inf": "Информатика", "sjl": "Словацкий язык", "anj": "Английский язык", "nej": "Немецкий язык", "frj": "Французский язык", "esp": "Испанский язык", "itj": "Итальянский язык", "ruj": "Русский язык", "ukj": "Украинский язык"}
}
