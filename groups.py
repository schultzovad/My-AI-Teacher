...
lang_data = {
    ...
    "IT": {"title": "👥 Gruppi di studio", "create": "Crea nuovo grupo", "name_label": "Nome del grupo", "lang_sel": "Lingua"},
    "UA": {"title": "👥 Навчальні групи", "create": "Створити групу", "name_label": "Назва групи", "lang_sel": "Мова"},
    "RU": {"title": "👥 Учебные skupiny", "create": "Создать группу", "name_label": "Название группы", "lang_sel": "Язык"}
}
