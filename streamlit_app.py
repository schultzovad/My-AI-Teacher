...
texty = {
    ...
    "FR": {"title": "🤖 Tuteur IA", "selected": "Fichier sélectionné:", "send_file": "Envoyer ⬆️", "input": "Question...", "file_msg": "*(Fichier: {name})*", "sys_prompt": "Répondez dans la langue dans laquelle l'utilisateur écrit."},
    ...
    "RU": {"title": "🤖 AI Тьютор", "selected": "Выбранный файл:", "send_file": "Отправить ⬆️", "input": "Спросить...", "file_msg": "*(Файл: {name})*", "sys_prompt": "Отвечайте на том языке, на котором пишет пользователь."}
}
...
st.markdown(f"""
    ...
    div[data-testid="stFileUploader"] section::after, div[data-testid="stFileUploader"] section::before,
                ...
                try:
                    ...
                    with chat_container:
                        with st.chat_message("assistant"):
                            res = model_ai.generate_content(f"{T['sys_prompt']} Krátko potvrď prijatie súboru {u.name}.")
